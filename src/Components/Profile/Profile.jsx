  ...
  if (!Auth.isAuthenticated) return <Navigate to="/login" replace />;
    ...
    return (
      <div>
        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto mt-2 ">
          <div
            id="profile"
            class="w-full  rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl dark:bg-white opacity-1 text-black mx-6 lg:mx-0"
          >
            <div class=" px-12 pb-12 text-center  ">
              <div
                class="block  rounded-full shadow-xl mx-auto -mt-12 h-48 w-48 bg-contain bg-white bg-no-repeat bg-center"
                style={{
              ...
              <div class="mx-auto w-2/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
              {user?.role && (
                <p class="pt-3 w-full  text-base font-bold flex justify-center align-middle ">
                  <svg
                    class="h-5 fill-current text-green-700"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                  >
                    <path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
                  </svg>{" "}
                  <span className="mx-2">{Auth?.user?.role}</span>
                </p>
              )}

              <p class="pt-4 w-full text-center  text-sm">
                Bio : {user?.about}
              </p>
              ...
              <div class="mt-6   w-3/5  mx-auto flex flex-wrap items-center justify-between">
                <a
                  class="link"
        ...
        <div className="w-5/6 mb-5 md:my-0 md:w-4/6 mx-auto">
