...
const SideMenu = (props) => {
  ...
  return (
    <div className={`${props.toggleSideMenu ? "block" : "hidden"}`}>
      <nav
        id="sidenav-3"
        class="fixed left-0 top-0 z-[1035] h-screen w-60 -translate-x-full overflow-hidden bg-[#f4f4f4] shadow-[0_12px_12px_0_rgba(0,0,0,0.2),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0"
      ...
      >
        <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
          <li class="relative">
            ...
            >
              <span
                class="text-white flex justify-end w-full"
                onClick={toggleFun}
              >
                ❌
              </span>
